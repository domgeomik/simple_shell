...
/**
 * fun_free_all - Free Array Of Char Pointer And Char Pointer
 * @cmd:Array Pointer
 * @line:Char Pointer
 * Return: Void
 */
void fun_free_all(char **cmd, char *line)
{
free(cmd);
free(line);
cmd = NULL;
...
/**
 * fun_fill_an_array - Fill An Array By Constant Byte
 * @a:Void Pointer
 * @el: Int
 * @len:Length Int
 *Return: Void Pointer
...
if (ptr == NULL)
{
fun_fill_an_array(result, '\0', new_size);
free(ptr);
}
else
{
